this.rf_random_trio <- this.inherit("scripts/scenarios/world/starting_scenario", {
	...
	function onSpawnAssets()
	{
		...
		for (local i = 1; i <= 3; ++i)
		{
			...
			bro.setStartValuesEx([::MSU.Array.rand(::Const.HireableCharacterBackgrounds)]);
